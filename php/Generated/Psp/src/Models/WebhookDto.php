...
class WebhookDto implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new WebhookDto and sets the default values.
    */
     ...
     * @return WebhookDto
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): WebhookDto {
