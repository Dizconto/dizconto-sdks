...
*/
class CustomerBillingDto_billingAddress implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new CustomerBillingDto_billingAddress and sets the default values.
    */
     ...
     * @return CustomerBillingDto_billingAddress
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): CustomerBillingDto_billingAddress {
        return new CustomerBillingDto_billingAddress();
    }
