...
*/
class CreateCustomerBillingDto_billingAddress implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new CreateCustomerBillingDto_billingAddress and sets the default values.
    */
     ...
     * @return CreateCustomerBillingDto_billingAddress
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): CreateCustomerBillingDto_billingAddress {
        return new CreateCustomerBillingDto_billingAddress();
    }
