...
class PaginatedWebhookDto_meta implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new PaginatedWebhookDto_meta and sets the default values.
    */
     ...
     * @return PaginatedWebhookDto_meta
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PaginatedWebhookDto_meta {
        return new PaginatedWebhookDto_meta();
    }
