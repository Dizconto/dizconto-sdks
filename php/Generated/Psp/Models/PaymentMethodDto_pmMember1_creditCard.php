...
class PaymentMethodDto_pmMember1_creditCard implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new PaymentMethodDto_pmMember1_creditCard and sets the default values.
    */
     ...
     * @return PaymentMethodDto_pmMember1_creditCard
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PaymentMethodDto_pmMember1_creditCard {
        return new PaymentMethodDto_pmMember1_creditCard();
    }
