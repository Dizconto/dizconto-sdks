...
namespace Dizconto\Pay\V1\Merchants;

use Dizconto\Pay\Models\MerchantDto;
use Dizconto\Pay\Models\PaginatedMerchantDto;
use Dizconto\Pay\V1\Merchants\Item\MerchantsItemRequestBuilder;
use Exception;
...
{
    /**
     * Gets an item from the Dizconto/Pay.v1.merchants.item collection
