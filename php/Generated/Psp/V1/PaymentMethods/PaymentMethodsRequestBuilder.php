...
namespace Dizconto\Pay\V1\PaymentMethods;

use Dizconto\Pay\Models\CreatePaymentMethodDto;
use Dizconto\Pay\Models\PaymentMethodDto;
use Dizconto\Pay\V1\PaymentMethods\Item\PaymentMethodsItemRequestBuilder;
use Exception;
...
{
    /**
     * Gets an item from the Dizconto/Pay.v1.paymentMethods.item collection
