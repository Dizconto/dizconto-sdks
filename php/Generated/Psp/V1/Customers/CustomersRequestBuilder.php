...
namespace Dizconto\Pay\V1\Customers;

use Dizconto\Pay\Models\CreateCustomerBillingDto;
use Dizconto\Pay\Models\CustomerBillingDto;
use Dizconto\Pay\V1\Customers\Item\CustomersItemRequestBuilder;
use Exception;
...
{
    /**
     * Gets an item from the Dizconto/Pay.v1.customers.item collection
