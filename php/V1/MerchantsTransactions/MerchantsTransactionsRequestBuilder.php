...
namespace DizcontoPay\V1\MerchantsTransactions;

use DizcontoPay\Models\PaginatedMerchantTransactionDto;
use DizcontoPay\V1\MerchantsTransactions\Item\MerchantsTransactionsItemRequestBuilder;
use Exception;
...
{
    /**
     * Gets an item from the DizcontoPay.v1.merchantsTransactions.item collection
