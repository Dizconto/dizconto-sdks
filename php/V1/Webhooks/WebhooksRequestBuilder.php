...
namespace DizcontoPay\V1\Webhooks;

use DizcontoPay\Models\CreateWebhookDto;
use DizcontoPay\Models\PaginatedWebhookDto;
use DizcontoPay\Models\WebhookDto;
use DizcontoPay\V1\Webhooks\Item\WebhooksItemRequestBuilder;
use Exception;
...
{
    /**
     * Gets an item from the DizcontoPay.v1.webhooks.item collection
