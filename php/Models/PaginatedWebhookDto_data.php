...
class PaginatedWebhookDto_data implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new PaginatedWebhookDto_data and sets the default values.
    */
     ...
     * @return PaginatedWebhookDto_data
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PaginatedWebhookDto_data {
        return new PaginatedWebhookDto_data();
    }
