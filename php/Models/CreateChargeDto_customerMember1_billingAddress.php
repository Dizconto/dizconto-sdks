...
*/
class CreateChargeDto_customerMember1_billingAddress implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new CreateChargeDto_customerMember1_billingAddress and sets the default values.
    */
     ...
     * @return CreateChargeDto_customerMember1_billingAddress
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): CreateChargeDto_customerMember1_billingAddress {
        return new CreateChargeDto_customerMember1_billingAddress();
    }
