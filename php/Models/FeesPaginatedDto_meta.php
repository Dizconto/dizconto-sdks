...
class FeesPaginatedDto_meta implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new FeesPaginatedDto_meta and sets the default values.
    */
     ...
     * @return FeesPaginatedDto_meta
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): FeesPaginatedDto_meta {
        return new FeesPaginatedDto_meta();
    }
