...
class PaginatedMerchantDto_meta implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new PaginatedMerchantDto_meta and sets the default values.
    */
     ...
     * @return PaginatedMerchantDto_meta
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PaginatedMerchantDto_meta {
        return new PaginatedMerchantDto_meta();
    }
