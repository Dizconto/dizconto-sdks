...
*/
class ChargeDto_customer_billingAddress implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new ChargeDto_customer_billingAddress and sets the default values.
    */
     ...
     * @return ChargeDto_customer_billingAddress
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): ChargeDto_customer_billingAddress {
        return new ChargeDto_customer_billingAddress();
    }
