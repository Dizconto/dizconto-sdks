...
class CreatePaymentMethodDto_pmMember1_creditCard implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new CreatePaymentMethodDto_pmMember1_creditCard and sets the default values.
    */
     ...
     * @return CreatePaymentMethodDto_pmMember1_creditCard
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): CreatePaymentMethodDto_pmMember1_creditCard {
        return new CreatePaymentMethodDto_pmMember1_creditCard();
    }
